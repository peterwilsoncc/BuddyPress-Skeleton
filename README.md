...
This is simply a skeleton repo for a BuddyPress site. Use it to jump-start your WordPress site repos, or fork it and customize it to your own liking!

## Assumptions

* WordPress as a Git submodule in `/wp/`
* BuddyPress as a Git submodule in `/content/plugins/buddypress/`
...
**Q:** What versions of WordPress and BuddyPress does this track?  
**A:** The latest stable releases. Send a pull request if I fall behind.
